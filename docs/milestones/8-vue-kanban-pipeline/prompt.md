...
3. Verify against the “Done when” criteria for milestone 8 in the PRD. `mix test` and Vitest are required. Use HTTP/browser checks when the feature is visible.
