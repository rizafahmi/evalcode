...
- Read previous milestone folders (`_build_plan/milestones/*/milestone-log.md`) to understand what has already been built. Milestone 1 has no prior log.
...
5. When complete, write `_build_plan/milestones/1-login-and-shell/milestone-log.md` with:
