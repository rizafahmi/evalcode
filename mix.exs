defmodule Sorak.MixProject do
  ...
  defp aliases do
    [
      ...
      "assets.setup": ["tailwind.install --if-missing", "cmd --cd assets pnpm install"],
      "assets.build": ["tailwind sorak", "cmd --cd assets pnpm run build"],
      "assets.deploy": [
      ...
      precommit: [
        ...
        "deps.unlock --unused",
        "cmd --cd assets pnpm run typecheck",
