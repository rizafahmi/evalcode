defmodule Alur.AccountsTest do
  ...
  alias Alur.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "registers users with password and hashes it" do
  ...
  describe "inspect/2 for the User module" do
    test "does not include password or hashed_password" do
      refute inspect(%User{password: "123456"}) =~ "password: \"123456\""
      refute inspect(%User{hashed_password: "secret_hash"}) =~ "secret_hash"
    end
  end
end
